...
## Required packages and data {.unnumbered}
...
However, since we're using Bayesian models to improve the predictions, we're not focusing on the dose-response (mechanism) effects. We're focusing on improving the acuracy of our model to predict current and future trends.
